      ...
      <SmoothScroll>
        <div className="bg-white min-h-screen text-plum selection:bg-mauve selection:text-white font-sans relative antialiased overflow-x-hidden">
          ...
          <a
            ...
            className="fixed bottom-6 right-6 md:bottom-10 md:right-10 z-[100] bg-plum/70 backdrop-blur-xl text-cream p-3.5 md:p-4 rounded-full shadow-[0_8px_32px_rgba(99,35,87,0.3)] border border-white/20 hover:bg-plum/90 hover:scale-110 hover:shadow-[0_15px_40px_rgba(99,35,87,0.5)] transition-all duration-300 flex items-center justify-center group"
